...
import {GetStepPauseFlag6,GetStepOneFlag6,GetRecipeEnd6,ClearRecipeEnd6} from './processing';
import {UpdateChamberTableFFChart} from './processing';
import {onClick} from  './processing';
import './App.css';
var zero = 1;
...
const updateDatasetPressure2 = () => { 
  ...
  const onButtonClick = () => {
    if(!FirstTime)
    {
       ...
       updateTemperature2();
       document.getElementById("UpdateBtn6").innerHTML = 'idle';
       FirstTime = true;
    }
...
const InitateUpdateRawDataOnClick = ()=>
  ...
  const UpdateByExternalAA = ()=> {
    ...
    {
      document.getElementById("UpdateBtn6").style.backgroundColor='green';
      document.getElementById("UpdateBtn6").style.color='white';
      document.getElementById("UpdateBtn6").innerHTML = 'Running...';
      if( !RepeatRunning )
      {  
        //for final redraw
        InitateUpdateRawData(0,0,0,0,0,0);
    ...
    {
      document.getElementById("UpdateBtn6").style.backgroundColor='white';
      document.getElementById("UpdateBtn6").style.color='black';
      document.getElementById("UpdateBtn6").innerHTML = 'idle'; 
      RepeatRunning = false;
    }
...
//   }
  ...
  const UpdateAA = ()=>{
    document.getElementById('h1CHF').innerHTML =  'Chamber F_' + PortID;
    var ObjectTemp = UpdateChamberTableFFChart();
    var VararrHeaderstr =[];
    var Paravalue =0;
    var Paravalue11 =0;
    //var PressureParavalue =0.0;
...
const UpdateChartDataParaAll22 = (pressure,sp,t1,t2,t3,t4)=> 
{
  ...
  return (
    <div id ='CHF' className="wrapper223Chart2">
     <h1 id = 'h1CHF' >Chamber F_ {PortID}</h1>
      <div>
          <button id = 'UpdateBtn6' onClick={onButtonClick3}>Update!</button> 
