...
import {GetStepPauseFlag5,GetStepOneFlag5,GetRecipeEnd5,ClearRecipeEnd5} from './processing';
import {UpdateChamberTableEEChart} from './processing';
import './App.css';
var index =0;
...
const InitateUpdateRawDataOnClick = ()=>
  ...
  const onButtonClick = () => {
    if(!FirstTime)
    {
      ...
      updateRFFinally2();
       ...
       document.getElementById("UpdateBtn5").innerHTML = 'idle';
       FirstTime = true;
    }
  ...
  const UpdateByExternalAA = ()=> {
    FlagStepPause1 = GetStepPauseFlag5(); 
    FlagStepOneStart = GetStepOneFlag5();
    FlagRecipeEnd = GetRecipeEnd5();
    scan = !FlagRecipeEnd;
    FlagPrerun =!FlagStepPause1;
      
    if(FlagPrerun || FlagStepOneStart)
    {
      document.getElementById("UpdateBtn5").style.backgroundColor='green';
      document.getElementById("UpdateBtn5").style.color='white';
      document.getElementById("UpdateBtn5").innerHTML = 'Running...';
      if( !RepeatRunning )
      {  
    ...
    {
      document.getElementById("UpdateBtn5").style.backgroundColor='white';
      document.getElementById("UpdateBtn5").style.color='black';
      document.getElementById("UpdateBtn5").innerHTML = 'idle'; 
      RepeatRunning = false;
    }  
   }; 
  ...
  const UpdateBB = ()=>{
    document.getElementById('h1CHE').innerHTML =  'Chamber E_' + PortID;
    var ObjectTemp = UpdateChamberTableEEChart();
    var VararrHeaderstr =[];
  ...
  return (
    <div id ='CHE' className="wrapper223Chart2">
      <h1 id = 'h1CHE' >Chamber E_ {PortID}</h1>
      <div>
      <button id = 'UpdateBtn5' onClick={onButtonClick3}>Update!</button> 
